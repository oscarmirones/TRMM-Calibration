...
counts.wt1 <- c()
for (i in unique(wt1$Year)[2:42]) {
  counts.wt1 <- c(counts.wt1, sum(cyc.wt1[which(wt1$Year == i),]$cyclones_generation_centers))
}

barplot(counts.wt1/sum(counts.wt1), names.arg = as.character(unique(wt1$Year)[2:42]), col = 'blue',
...
counts.wt2 <- c()
for (i in unique(wt2$Year)[2:42]) {
  counts.wt2 <- c(counts.wt2, sum(cyc.wt2[which(wt2$Year == i),]$cyclones_generation_centers))
}

barplot(counts.wt2/sum(counts.wt2), names.arg = as.character(unique(wt2$Year)[2:42]), col = 'blue',
...
counts.wt3 <- c()
for (i in unique(wt3$Year)[2:42]) {
  counts.wt3 <- c(counts.wt3, sum(cyc.wt3[which(wt3$Year == i),]$cyclones_generation_centers))
}

barplot(counts.wt3/sum(counts.wt3), names.arg = as.character(unique(wt3$Year)[2:42]), col = 'blue',
...
counts.wt4 <- c()
for (i in unique(wt4$Year)[2:42]) {
  counts.wt4 <- c(counts.wt4, sum(cyc.wt4[which(wt4$Year == i),]$cyclones_generation_centers))
}

barplot(counts.wt4/sum(counts.wt4), names.arg = as.character(unique(wt4$Year)[2:42]), col = 'blue',
...
counts.wt5 <- c()
for (i in unique(wt5$Year)[2:42]) {
  counts.wt5 <- c(counts.wt5, sum(cyc.wt5[which(wt5$Year == i),]$cyclones_generation_centers))
}

barplot(counts.wt5/sum(counts.wt5), names.arg = as.character(unique(wt5$Year)[2:42]), col = 'blue',
