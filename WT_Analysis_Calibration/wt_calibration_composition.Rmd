...
```{r}
df <- data.frame(index.obs.cl1, index.trmm.cl1, index.cal.station.cl1.pqm, index.cal.station.cl1.eqm, index.cal.station.cl1.gpqm, index.cal.station.cl1.gpqm2)
...
```{r}
df <- data.frame(index.obs.cl2, index.trmm.cl2, index.cal.station.cl2.pqm, index.cal.station.cl2.eqm, index.cal.station.cl2.gpqm, index.cal.station.cl2.gpqm2)
...
```{r}
df <- data.frame(index.obs.cl3, index.trmm.cl3, index.cal.station.cl3.pqm, index.cal.station.cl3.eqm, index.cal.station.cl3.gpqm, index.cal.station.cl3.gpqm2)
...
```{r}
df <- data.frame(index.obs.cl4, index.trmm.cl4, index.cal.station.cl4.pqm, index.cal.station.cl4.eqm, index.cal.station.cl4.gpqm, index.cal.station.cl4.gpqm2)
...
```{r}
df <- data.frame(index.obs.cl5, index.trmm.cl5, index.cal.station.cl5.pqm, index.cal.station.cl5.eqm, index.cal.station.cl5.gpqm, index.cal.station.cl5.gpqm2)
...
wt_conditioned <- bindGrid(cal.station.cl1.eqm, cal.station.cl2.eqm, cal.station.cl3.gpqm2,
                           cal.station.cl4.gpqm2, cal.station.cl5.gpqm, dimension = "time")
...
```{r}
qqplot(station.obs$Data, wt_conditioned$Data, main = paste(station.obs$Metadata$name), xlab = "Observed (mm)", ylab = "Predicted (mm)", col = "black", pch = 2, cex = .5)
...
```{r}
wt_conditioned <- bindGrid(cal.station.cl1.eqm, cal.station.cl2.eqm, cal.station.cl3.gpqm2,
                           cal.station.cl4.gpqm2, cal.station.cl5.eqm, dimension = "time")
...
```{r}
wt_conditioned <- bindGrid(cal.station.cl1.eqm, cal.station.cl2.eqm, cal.station.cl3.gpqm2,
                           cal.station.cl4.pqm, cal.station.cl5.gpqm, dimension = "time")
...
```{r}
wt_conditioned <- bindGrid(cal.station.cl1.eqm, cal.station.cl2.eqm, cal.station.cl3.gpqm2,
                           cal.station.cl4.eqm, cal.station.cl5.gpqm, dimension = "time")
...
```{r}
qqplot(station.obs$Data, combination1$Data, main = paste(station.obs$Metadata$name), xlab = "Observed (mm)", ylab = "Predicted (mm)", col = "black", pch = 2, cex = .5)

abline(a = 0, b = 1)


points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination2$Data[!is.na(station.obs$Data)][order(combination2$Data[!is.na(station.obs$Data)])], col = "red", pch = 3, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination3$Data[!is.na(station.obs$Data)][order(combination3$Data[!is.na(station.obs$Data)])], col = "pink", pch = 3, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination4$Data[!is.na(station.obs$Data)][order(combination4$Data[!is.na(station.obs$Data)])], col = "blue", pch = 2, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination5$Data[!is.na(station.obs$Data)][order(combination5$Data[!is.na(station.obs$Data)])], col = "green", pch = 2, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination6$Data[!is.na(station.obs$Data)][order(combination6$Data[!is.na(station.obs$Data)])], col = "gold", pch = 3, cex = .5)
...
```{r}
qqplot(station.obs$Data, combination7$Data, main = paste(station.obs$Metadata$name), xlab = "Observed (mm)", ylab = "Predicted (mm)", col = "black", pch = 2, cex = .5)

abline(a = 0, b = 1)


points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination8$Data[!is.na(station.obs$Data)][order(combination8$Data[!is.na(station.obs$Data)])], col = "red", pch = 3, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination9$Data[!is.na(station.obs$Data)][order(combination9$Data[!is.na(station.obs$Data)])], col = "pink", pch = 3, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination10$Data[!is.na(station.obs$Data)][order(combination10$Data[!is.na(station.obs$Data)])], col = "blue", pch = 2, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination11$Data[!is.na(station.obs$Data)][order(combination11$Data[!is.na(station.obs$Data)])], col = "green", pch = 2, cex = .5)

points(station.obs$Data[!is.na(station.obs$Data)][order(station.obs$Data[!is.na(station.obs$Data)])], combination12$Data[!is.na(station.obs$Data)][order(combination12$Data[!is.na(station.obs$Data)])], col = "gold", pch = 3, cex = .5)
