...
points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(rep(0,2), combination2$Data), col = "red", pch = 3, cex = .5)

points(sort(station.obs$Data[!is.na(station.obs$Data)]), combination3$Data, col = "pink", pch = 3, cex = .5)
 
points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(rep(0,2), combination4$Data), col = "blue", pch = 2, cex = .5)
 
points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(0,combination5$Data), col = "green", pch = 2, cex = .5)

points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(rep(0,2), combination6$Data), col = "gold", pch = 3, cex = .5)
...
points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(rep(0,2), combination8$Data), col = "red", pch = 3, cex = .5)

points(sort(station.obs$Data[!is.na(station.obs$Data)]), combination9$Data, col = "pink", pch = 3, cex = .5)
 
points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(rep(0,2), combination10$Data), col = "blue", pch = 2, cex = .5)
 
points(sort(station.obs$Data[!is.na(station.obs$Data)]), combination11$Data, col = "green", pch = 2, cex = .5)
