...
points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(rep(0,2),combination5$Data), col = "green", pch = 2, cex = .5)

points(sort(station.obs$Data[!is.na(station.obs$Data)]), c(rep(0,3), combination6$Data), col = "gold", pch = 3, cex = .5)
