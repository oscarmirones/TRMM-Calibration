...
```{r}
plot(x = c(1,2,3,4,5,6,7),y = c(bias.df.st1[4,1],bias.df.st2[4,1],bias.df.st3[4,1],bias.df.st4[4,1],bias.df.st5[4,1],bias.df.st6[4,1],bias.df.st7[4,1]), col = "black", pch = 2, ylab = "R10p Bias Value", xlab = "Station", ylim = c(0,20000))
points(x = c(1,2,3,4,5,6,7),y = c(bias.df.st1[4,2],bias.df.st2[4,2],bias.df.st3[4,2],bias.df.st4[4,2],bias.df.st5[4,2],bias.df.st6[4,2],bias.df.st7[4,2]), col = "blue", pch = 4)
```

```{r}
plot(x = c(1,2,3,4,5,6,7),y = c(bias.df.st1[6,1],bias.df.st2[6,1],bias.df.st3[6,1],bias.df.st4[6,1],bias.df.st5[6,1],bias.df.st6[6,1],bias.df.st7[6,1]), col = "black", pch = 2, ylab = "R20p Bias Value", xlab = "Station", ylim = c(0,20000))
points(x = c(1,2,3,4,5,6,7),y = c(bias.df.st1[6,2],bias.df.st2[6,2],bias.df.st3[6,2],bias.df.st4[6,2],bias.df.st5[6,2],bias.df.st6[6,2],bias.df.st7[6,2]), col = "blue", pch = 4)
```


```{r}
plot(x = c(1,2,3,4,5,6,7),y = c(bias.df.st1[8,1],bias.df.st2[8,1],bias.df.st3[8,1],bias.df.st4[8,1],bias.df.st5[8,1],bias.df.st6[8,1],bias.df.st7[8,1]), col = "black", pch = 2, ylab = "P98WetAmount Bias Value", xlab = "Station", ylim = c(0,2000))
points(x = c(1,2,3,4,5,6,7),y = c(bias.df.st1[8,2],bias.df.st2[8,2],bias.df.st3[8,2],bias.df.st4[8,2],bias.df.st5[8,2],bias.df.st6[8,2],bias.df.st7[8,2]), col = "blue", pch = 4)
```
