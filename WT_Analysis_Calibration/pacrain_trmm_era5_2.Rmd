...
```
```{r}
paste(length(wind.cl.1$sustained_wind),length(wind.cl.2$sustained_wind),length(wind.cl.3$sustained_wind),length(wind.cl.4$sustained_wind),length(wind.cl.5$sustained_wind))
```
```{r}
cluster_wind1 <- c()
cluster_wind2 <- c()
