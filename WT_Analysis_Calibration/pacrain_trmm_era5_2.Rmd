...
```
```{r}
cyclones <- read.csv('C:/Users/usuario/Desktop/Master/tfm/Notebooks_TFM/SP_cyclones_time_series.csv')
...
```{r}
levelplot(Z ~ X*Y, data=data  ,xlab="WT", ylab = "Month",
          main="", col.regions = rev(hcl.colors(100,palette = 'inferno')))+    layer(sp.points(cyc.data, pch = 19, cex = cyc.data$Z/125, col = 'blue'))
```
