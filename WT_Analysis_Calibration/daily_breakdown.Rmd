...
spatialPlot(kmedias.pp,backdrop.theme = 'countries', rev.color = F, as.table = T,colorkey = list(space ="bottom",height=1, width=1), color.theme = 'BrBG', names.attr = paste("Days in cluster", 1:k, ":",kmModel5$size[1:k]))
```
