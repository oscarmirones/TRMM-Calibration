...
score.trmm <- (sum(score.trmm[1:2])+2*sum(score.trmm[3:9]))/16

score.era5 <- c()
for (i in c(1:9)) {
  score.era5 <- c(score.era5, norm.vector[[i]][2]) 
}
score.era5 <- (sum(score.era5[1:2])+2*sum(score.era5[3:9]))/16

score.pqm <- c()
for (i in c(1:9)) {
  score.pqm <- c(score.pqm, norm.vector[[i]][3]) 
}
score.pqm <- (sum(score.pqm[1:2])+2*sum(score.pqm[3:9]))/16
...
score.eqm <- (sum(score.eqm[1:2])+2*sum(score.eqm[3:9]))/16
...
score.gpqm <- (sum(score.gpqm[1:2])+2*sum(score.gpqm[3:9]))/16
...
score.gpqm2 <- (sum(score.gpqm2[1:2])+2*sum(score.gpqm2[3:9]))/16
...
score.trmm <- (sum(score.trmm[1:2])+3*sum(score.trmm[3:9]))/23

score.era5 <- c()
for (i in c(1:9)) {
  score.era5 <- c(score.era5, norm.vector[[i]][2]) 
}
score.era5 <- (sum(score.era5[1:2])+3*sum(score.era5[3:9]))/23

score.pqm <- c()
for (i in c(1:9)) {
  score.pqm <- c(score.pqm, norm.vector[[i]][3]) 
}
score.pqm <- (sum(score.pqm[1:2])+3*sum(score.pqm[3:9]))/23
...
score.eqm <- (sum(score.eqm[1:2])+3*sum(score.eqm[3:9]))/23
...
score.gpqm <- (sum(score.gpqm[1:2])+3*sum(score.gpqm[3:9]))/23
...
score.gpqm2 <- (sum(score.gpqm2[1:2])+3*sum(score.gpqm2[3:9]))/23
