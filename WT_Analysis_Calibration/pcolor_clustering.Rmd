...
levelplot(Z ~ X*Y, data=data  ,xlab="WT", ylab = "Month",
          main="", col.regions = rev(hcl.colors(100,palette = 'GnBu')))+          layer(sp.points(cyc.data, pch = 19, cex = cyc.data$Z/550, col = 'blue'))+
  layer(panel.segments(0,5.5,1.5,5.5, col = 'blue', lwd = 2))+
  layer(panel.segments(0,10.5,1.5,10.5, col = 'blue', lwd = 2))+
  layer(panel.segments(1.5,0,1.5,5.5, col = 'blue', lwd = 2))+
  layer(panel.segments(1.5,10.5,1.5,12.5, col = 'blue', lwd = 2))+
  layer(panel.segments(0.51,10.5,0.51,12.45, col = 'blue', lwd = 2))+
  layer(panel.segments(0.51,0.5,0.51,5.5, col = 'blue', lwd = 2))+
  
  layer(panel.segments(1.5,6.5,2.5,6.5, col = 'blue', lwd = 2))+
  layer(panel.segments(1.5,10.5,2.5,10.5, col = 'blue', lwd = 2))+
  layer(panel.segments(2.5,0,2.5,6.5,col = 'blue', lwd = 2))+
  layer(panel.segments(1.5,5.5,1.5,6.5, col = 'blue', lwd = 2))+
  layer(panel.segments(2.5,10.5,2.5,12.5, col = 'blue', lwd = 2))+
  
  layer(panel.segments(2.5,3.5,3.5,3.5, col = 'blue', lwd = 2))+
  layer(panel.segments(2.5,10.5,3.5,10.5, col = 'blue', lwd = 2))+
  layer(panel.segments(3.5,3.5,3.5,10.5, col = 'blue', lwd = 2))+
  layer(panel.segments(2.5,6.5,2.5,10.5, col = 'blue', lwd = 2))+
  
  layer(panel.segments(3.5,11.5,4.5,11.5, col = 'blue', lwd = 2))+
  layer(panel.segments(3.5,3.5,4.5,3.5, col = 'blue', lwd = 2))+
  layer(panel.segments(3.5,0,3.5,3.5, col = 'blue', lwd = 2))+
  layer(panel.segments(4.5,0,4.5,3.5, col = 'blue', lwd = 2))+
  layer(panel.segments(3.5,11.5,3.5,12.5, col = 'blue', lwd = 2))+
  layer(panel.segments(4.5,11.5,4.5,12.5, col = 'blue', lwd = 2))+

  layer(panel.segments(4.5,4.5,5.5,4.5, col = 'blue', lwd = 2))+
  layer(panel.segments(4.5,10.5,5.5,10.5, col = 'blue', lwd = 2))+
  layer(panel.segments(4.5,4.5,4.5,10.5, col = 'blue', lwd = 2))+
  layer(panel.segments(5.5,4.5,5.5,10.5, col = 'blue', lwd = 2))
grid.text("N Obs", .94, .13)
```
