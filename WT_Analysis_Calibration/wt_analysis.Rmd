...
```{r}
temporalPlot(wallis.futuna.trmm,wallis.futuna.obs, xyplot.custom = list(main = "Precipitation", ylab = "mm"))
```
...
```{r}
temporalPlot(station.trmm,station.obs, xyplot.custom = list(main = paste("Precipitation",station.trmm$Metadata$station_id), ylab = "mm"))
```
