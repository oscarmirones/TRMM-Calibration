...
```{r}
index.cal.madrid.eqm.extrapol <- valueIndex1D(cal.madrid.eqm.extrapol$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
```
...
```{r}
 diff.madrid <- data.frame(abs(index.obs.madrid-index.trmm.madrid),abs(index.obs.madrid-index.cal.madrid.scaling),
                      abs(index.obs.madrid-index.cal.madrid.eqm), abs(index.obs.madrid - index.cal.madrid.eqm.extrapol), abs(index.obs.madrid-index.cal.madrid.pqm), abs(index.obs.madrid-index.cal.madrid.gpqm)
                      )
...
```{r}
 diff.madrid.noabs <- data.frame(index.obs.madrid-index.trmm.madrid,index.obs.madrid-index.cal.madrid.scaling,
                      index.obs.madrid-index.cal.madrid.eqm, index.obs.madrid - index.cal.madrid.eqm.extrapol, index.obs.madrid-index.cal.madrid.pqm, index.obs.madrid-index.cal.madrid.gpqm)
...
index.cal.malaga.eqm.extrapol <- valueIndex1D(cal.malaga.eqm.extrapol$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
```{r}
 diff.malaga <- data.frame(abs(index.obs.malaga-index.trmm.malaga),abs(index.obs.malaga-index.cal.malaga.scaling),
                      abs(index.obs.malaga-index.cal.malaga.eqm),abs(index.obs.malaga-index.cal.malaga.eqm.extrapol), abs(index.obs.malaga-index.cal.malaga.pqm), abs(index.obs.malaga-index.cal.malaga.gpqm)
                      )
...
```
```{r}
 diff.malaga.noabs <- data.frame(index.obs.malaga-index.trmm.malaga,index.obs.malaga-index.cal.malaga.scaling,
                      index.obs.malaga-index.cal.malaga.eqm, index.obs.malaga - index.cal.malaga.eqm.extrapol, index.obs.malaga-index.cal.malaga.pqm, index.obs.malaga-index.cal.malaga.gpqm)
...
index.cal.mallorca.eqm.extrapol <- valueIndex1D(cal.mallorca.eqm.extrapol$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
```{r}
 diff.mallorca <- data.frame(abs(index.obs.mallorca-index.trmm.mallorca),abs(index.obs.mallorca-index.cal.mallorca.scaling),
                      abs(index.obs.mallorca-index.cal.mallorca.eqm),abs(index.obs.mallorca-index.cal.mallorca.eqm.extrapol), abs(index.obs.mallorca-index.cal.mallorca.pqm), abs(index.obs.mallorca-index.cal.mallorca.gpqm)
                      )
...
```
```{r}
 diff.mallorca.noabs <- data.frame(index.obs.mallorca-index.trmm.mallorca,index.obs.mallorca-index.cal.mallorca.scaling,
                      index.obs.mallorca-index.cal.mallorca.eqm, index.obs.mallorca - index.cal.mallorca.eqm.extrapol, index.obs.mallorca-index.cal.mallorca.pqm, index.obs.mallorca-index.cal.mallorca.gpqm)
...
index.cal.sansebastian.eqm.extrapol <- valueIndex1D(cal.sansebastian.eqm.extrapol$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
```{r}
 diff.sansebastian <- data.frame(abs(index.obs.sansebastian-index.trmm.sansebastian),abs(index.obs.sansebastian-index.cal.sansebastian.scaling),
                      abs(index.obs.sansebastian-index.cal.sansebastian.eqm),abs(index.obs.sansebastian-index.cal.sansebastian.eqm.extrapol), abs(index.obs.sansebastian-index.cal.sansebastian.pqm), abs(index.obs.sansebastian-index.cal.sansebastian.gpqm)
                      )
...
```
```{r}
 diff.sansebastian.noabs <- data.frame(index.obs.sansebastian-index.trmm.sansebastian,index.obs.sansebastian-index.cal.sansebastian.scaling,
                      index.obs.sansebastian-index.cal.sansebastian.eqm, index.obs.sansebastian - index.cal.sansebastian.eqm.extrapol, index.obs.sansebastian-index.cal.sansebastian.pqm, index.obs.sansebastian-index.cal.sansebastian.gpqm)
...
index.obs.navacerrada <- valueIndex1D(obs.navacerrada$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))

index.trmm.navacerrada <- valueIndex1D(trmm.navacerrada$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.navacerrada.scaling <- valueIndex1D(cal.navacerrada.scaling$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.navacerrada.eqm <- valueIndex1D(cal.navacerrada.eqm$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.navacerrada.eqm.extrapol <- valueIndex1D(cal.navacerrada.eqm.extrapol$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.navacerrada.pqm <- valueIndex1D(cal.navacerrada.pqm$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.navacerrada.gpqm <- valueIndex1D(cal.navacerrada.gpqm$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
```
...
```{r}
 diff.navacerrada <- data.frame(abs(index.obs.navacerrada-index.trmm.navacerrada),abs(index.obs.navacerrada-index.cal.navacerrada.scaling),
                      abs(index.obs.navacerrada-index.cal.navacerrada.eqm),abs(index.obs.navacerrada-index.cal.navacerrada.eqm.extrapol), abs(index.obs.navacerrada-index.cal.navacerrada.pqm), abs(index.obs.navacerrada-index.cal.navacerrada.gpqm)
                      )
...
```
```{r}
 diff.navacerrada.noabs <- data.frame(index.obs.navacerrada-index.trmm.navacerrada,index.obs.navacerrada-index.cal.navacerrada.scaling,
                      index.obs.navacerrada-index.cal.navacerrada.eqm, index.obs.navacerrada - index.cal.navacerrada.eqm.extrapol, index.obs.navacerrada-index.cal.navacerrada.pqm, index.obs.navacerrada-index.cal.navacerrada.gpqm)
...
index.obs.santiago <- valueIndex1D(obs.santiago$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))

index.trmm.santiago <- valueIndex1D(trmm.santiago$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.santiago.scaling <- valueIndex1D(cal.santiago.scaling$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.santiago.eqm <- valueIndex1D(cal.santiago.eqm$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.santiago.eqm.extrapol <- valueIndex1D(cal.santiago.eqm.extrapol$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.santiago.pqm <- valueIndex1D(cal.santiago.pqm$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
...
index.cal.santiago.gpqm <- valueIndex1D(cal.santiago.gpqm$Data,index.codes=c("Skewness","R10","P98Wet","P98WetAmount"))
```
...
```{r}
 diff.santiago <- data.frame(abs(index.obs.santiago-index.trmm.santiago),abs(index.obs.santiago-index.cal.santiago.scaling),
                      abs(index.obs.santiago-index.cal.santiago.eqm),abs(index.obs.santiago-index.cal.santiago.eqm.extrapol), abs(index.obs.santiago-index.cal.santiago.pqm), abs(index.obs.santiago-index.cal.santiago.gpqm)
                      )
...
```
```{r}
 diff.santiago.noabs <- data.frame(index.obs.santiago-index.trmm.santiago,index.obs.santiago-index.cal.santiago.scaling,
                      index.obs.santiago-index.cal.santiago.eqm, index.obs.santiago - index.cal.santiago.eqm.extrapol, index.obs.santiago-index.cal.santiago.pqm, index.obs.santiago-index.cal.santiago.gpqm)
