...
```{r}
severalQQPlot <- function(obs, trmm, scaling, eqm, eqm.extrapol, pqm, gpqm){
  qqplot(obs$Data, trmm$Data, main = "Obs,TRMM and calibration QQplot", xlab = "Observed (mm)", ylab = "TRMM/Calibration (mm)", col = "black", pch = 2, cex = .5)
...
points(sort(obs$Data), sort(pqm$Data), col = "yellow", pch = 19, cex = .5)
points(sort(obs$Data), sort(gpqm$Data), col = "grey", pch = 19, cex = .5)


legend("topleft", legend = c("TRMM","Scaling","EQM", "EQM extrapol", "PQM","GPQM"), pch = c(2,4,4,19,19,19), col = c("black", "pink","red","blue","yellow","grey"))
}
```

```{r}
severalQQPlot(obs.santiago,trmm.santiago,cal.santiago.scaling, cal.santiago.eqm, cal.santiago.eqm.extrapol, cal.santiago.pqm, cal.santiago.gpqm)
```
