...
colnames(results.madrid) <- c("Obs","TRMM","Scaling cal.", "EQM cal.","EQM cal. Extrapol", "PQM cal.","GPQM cal.")
...
colnames(diff.madrid) <- c("TRMM","Scaling cal.", "EQM cal.","EQM cal.Extrapol", "PQM cal.","GPQM cal.")
...
legend(1, 95, legend=c("Obs", "TRMM", "Scaling cal."),col=c("black","red", "blue"))
```
...
legend(1, 95, legend=c("Obs", "TRMM", "EQM cal."),col=c("black","red", "blue"))
```
...
legend(1, 95, legend=c("Obs", "TRMM", "EQM extrapol cal."),col=c("black","red", "blue"))
```
...
legend(1, 95, legend=c("Obs", "TRMM", "PQM cal."),col=c("black","red", "blue"))
```
...
legend(1, 95, legend=c("Obs", "TRMM", "GPQM cal."),col=c("black","red", "blue"))
```
